...
$playerGroups = array(
    "group1" => array(        
        ...
        "/seen <player>" => "yes, check when another player was last seen online",
        "/fish, /fish shop, etc" => "yes, all players can get custom fish in the survival worlds",
        "/farm, /fash shop, etc" => "yes, all players have access to custom farming in all worlds",
        "mcMMO features (/mcstats, /mcrank, /mctop" => "yes, all players get exp for MMO in the survival worlds",
        "/back and /dback" => "yes, /back to last teleported-away point, and back to last death location",
        "/homes commands (/sethome, /removehome, /home, and /homes" => "yes, access to 3 homes max (and a bed home)",
        "/craft, /loom, /smithingtable, /stonecutter" => "yes, access to handy on the go tools",
        "/j (and compass use)" => "no, this is limited to Tier 2 builders groups (and up)",
        "/ender (/ec)" => "yes, all players have access to their ender chest on the go tool",
        "/msg (/r, /w, /whisper" => "yes, all players can globally message each other (gets moderated)",
        "/mail (/mail read, /mail send, delete, etc)" => "yes, all players can leave another player mail (and read theirs)",
        "/sell (and /worth)" => "yes, all players can sell to the server based on /worth, in the survival worlds",
        "/warp <name> (and /warps)" => "yes, all public warps can be visited by all players",
        "/visit (personal warp) (player warps)" => "Unreleased feature, coming 2024",
        "/tpa <player> (and /tpaccept, /tpahere" => "yes, all players can request to teleport to another player, only in the survival worlds.",
