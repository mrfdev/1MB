...
# @Version: 2.14, build 052 for Minecraft 1.19.2 (Java 19.0.1, 64bit)
...
_engine=""
# "" assumes auto detection for <engine>-1.19.2.jar 
# "spigot" assumes to look for spigot-1.19.2.jar
# "paper" assumes to look for paper-1.19.2.jar
...
# leave "" if you want the 1.19.2 server-gui
_noGui="--nogui"
