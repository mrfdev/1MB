...
# @Version: 2.15.0, build 054 for Minecraft 1.19.3 (Java 19.0.2, 64bit)
...
# Example: (16GB host for dedicated Paper 1.19.3 server with custom flags, using 10GB ram, etc.)
...
_engine=""
# "" assumes auto detection for <engine>-1.19.3.jar 
# "spigot" assumes to look for spigot-1.19.3.jar
# "paper" assumes to look for paper-1.19.3.jar
...
# leave "" if you want the 1.19.3 server-gui
_noGui="--nogui"
